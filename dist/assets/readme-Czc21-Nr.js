...
This is less a distinct field and more of a database for all of the questions and answers we receive for commonly asked questions. This should be searchable and filterable by housing law topic. Under each card, we should have a window containing the Q/A already set to the right housing law filter to show questions for that particular law.`;export{e as default};
